...
// File Location : /var/www/html/<project>/view/js/projector.js
...
function globalSave() {
  ...
  if (displayFullScreenCKfield && CKEDITOR.instances[displayFullScreenCKfield] && CKEDITOR.instances[displayFullScreenCKfield].readOnly) return;
  if (!button) {
